...
#ifndef _FXXH_ADAG_LEARNER_H_
#define _FXXH_ADAG_LEARNER_H_
...
class FxxhAdagLearner : public Learner {
 public:
  FxxhAdagLearner():eta_(0.1f), l2_fm_(0.f), alpha_(.1f), beta_(1.f) {}
